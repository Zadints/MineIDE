...
public class ServesController {
    ...
    */
    ...
    void sofwarerequest() throws Exception {
        ...
        Server actualserver = new Server(IdGenerate.getNewId(),namefield.getText() ,path , ramslider.getValue(), ssdslider.getValue(), cpuslider.getValue(), Short.parseShort(portfield.getText()), imagepath ,updatable, org.example.mineide.core.enums.dsdsd.valueOf(softwarebox.getValue().toString()), Short.valueOf(versionbox.getValue().toString()));
